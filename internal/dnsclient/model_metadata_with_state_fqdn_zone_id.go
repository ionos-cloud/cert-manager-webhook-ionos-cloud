...
type _MetadataWithStateFqdnZoneId MetadataWithStateFqdnZoneId
...
func (o *MetadataWithStateFqdnZoneId) UnmarshalJSON(data []byte) (err error) {
	...
	varMetadataWithStateFqdnZoneId := _MetadataWithStateFqdnZoneId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetadataWithStateFqdnZoneId)

	if err != nil {
		return err
	}

	*o = MetadataWithStateFqdnZoneId(varMetadataWithStateFqdnZoneId)
