...
type _RecordCreate RecordCreate
...
func (o *RecordCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varRecordCreate := _RecordCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecordCreate)

	if err != nil {
		return err
	}

	*o = RecordCreate(varRecordCreate)
