...
type _MetadataWithStateNameservers MetadataWithStateNameservers
...
func (o *MetadataWithStateNameservers) UnmarshalJSON(data []byte) (err error) {
	...
	varMetadataWithStateNameservers := _MetadataWithStateNameservers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetadataWithStateNameservers)

	if err != nil {
		return err
	}

	*o = MetadataWithStateNameservers(varMetadataWithStateNameservers)
