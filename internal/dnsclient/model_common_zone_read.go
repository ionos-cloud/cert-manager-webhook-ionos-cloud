...
type _CommonZoneRead CommonZoneRead
...
func (o *CommonZoneRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonZoneRead := _CommonZoneRead{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonZoneRead)

	if err != nil {
		return err
	}

	*o = CommonZoneRead(varCommonZoneRead)
