...
func (o *RecordRead) UnmarshalJSON(data []byte) (err error) {
	...
	varRecordRead := _RecordRead{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecordRead)

	if err != nil {
		return err
	}

	*o = RecordRead(varRecordRead)
