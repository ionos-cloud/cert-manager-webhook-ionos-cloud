...
type _RecordReadList RecordReadList
...
func (o *RecordReadList) UnmarshalJSON(data []byte) (err error) {
	...
	varRecordReadList := _RecordReadList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecordReadList)

	if err != nil {
		return err
	}

	*o = RecordReadList(varRecordReadList)
