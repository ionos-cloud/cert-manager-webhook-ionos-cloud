...
func (o *CommonZone) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonZone := _CommonZone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonZone)

	if err != nil {
		return err
	}

	*o = CommonZone(varCommonZone)
