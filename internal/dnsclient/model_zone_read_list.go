...
type _ZoneReadList ZoneReadList
...
func (o *ZoneReadList) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneReadList := _ZoneReadList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneReadList)

	if err != nil {
		return err
	}

	*o = ZoneReadList(varZoneReadList)
