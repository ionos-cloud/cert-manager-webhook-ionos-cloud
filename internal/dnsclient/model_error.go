...
type Error struct {
	...
	Messages   []ErrorMessagesInner `json:"messages,omitempty"`
}
...
func (o *Error) GetMessages() []ErrorMessagesInner {
	if o == nil || IsNil(o.Messages) {
		var ret []ErrorMessagesInner
		return ret
	}
	return o.Messages
}
...
// and a boolean to check if the value has been set.
func (o *Error) GetMessagesOk() ([]ErrorMessagesInner, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
// SetMessages gets a reference to the given []ErrorMessagesInner and assigns it to the Messages field.
func (o *Error) SetMessages(v []ErrorMessagesInner) {
	o.Messages = v
}
